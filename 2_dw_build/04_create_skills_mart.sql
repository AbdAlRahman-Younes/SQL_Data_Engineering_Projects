...
-- 1. Skills dimension
SELECT '=== Loading skills_mart.dim_skill Table ===' AS info;
...
SELECT '=== Loading skills_mart.dim_date_month Table ===' AS info;
...
SELECT '=== Loading skills_mart.fact_skill_demand Table ===' AS info;
...
ORDER BY postings_count DESC, month_start_date DESC
LIMIT 10;